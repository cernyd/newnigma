...
@pytest.mark.parametrize('model, rotors, reflector, positions, ring_settings, plug_pairs, message, correct_result', (
    (  # Enigma instruction manual message
        'Enigma1', ('II', 'I', 'III'), 'UKW-A', "ABL", (24, 13, 22), ("AM", "FI", "NV", "PS", "TU", "WZ"),
    ...
    (  # Operation Barbarossa message 1
        'EnigmaM3', ('II', 'IV', 'V'), 'UKW-B', "BLA", (2, 21, 12),  ("AV", "BS", "CG", "DL", "FU", "HZ", "IN", "KM", "OW", "RX"),
    ...
    (  # Operation Barbarossa message 2
        'EnigmaM3', ('II', 'IV', 'V'), 'UKW-B', "LSD", (2, 21, 12),  ("AV", "BS", "CG", "DL", "FU", "HZ", "IN", "KM", "OW", "RX"),
    ...
    (  # Schranhorst
        'EnigmaM3', ('III', 'VI', 'VIII'), 'UKW-B', "UZV", (1, 8, 13), ("AN", "EZ", "HK", "IJ", "LR", "MQ", "OT", "PV", "SW", "UX"),
    ...
    (  # U-264
        'EnigmaM4', ('Beta', 'II', 'IV', 'I'), 'UKW-b', "VJNA", (1, 1, 1, 22), ("AT", "BL", "DF", "GJ", "HM", "NW", "OP", "QY", "RZ", "VX"),
